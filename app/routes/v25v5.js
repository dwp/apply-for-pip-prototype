...
router.post('/v25v5/health-form/about-your-health/health-condition-list-1', (req, res, next) => {
  res.redirect('/v25v5/health-form/about-your-health/health-condition-details-1');
});


router.post('/v25v5/health-form/about-your-health/health-condition-details-1', (req, res, next) => {
  res.redirect('/v25v5/health-form/about-your-health/health-condition-cya-1');
});

router.post('/v25v5/health-form/about-your-health/health-condition-cya-1', (req, res, next) => {
res.redirect('/v25v5/health-form/about-your-health/health-condition-cya-final');
});
...
router.post('/v25v5/health-form/about-your-health/health-condition-list-2', (req, res, next) => {
  res.redirect('/v25v5/health-form/about-your-health/health-condition-details-2');
});


router.post('/v25v5/health-form/about-your-health/health-condition-details-2', (req, res, next) => {
  res.redirect('/v25v5/health-form/about-your-health/health-condition-cya-2');
});


router.post('/v25v5/health-form/about-your-health/health-condition-cya-2', (req, res, next) => {
res.redirect('/v25v5/health-form/about-your-health/health-condition-cya-final');
});
...
router.post('/v25v5/health-form/about-your-health/health-condition-list-3', (req, res, next) => {
  res.redirect('/v25v5/health-form/about-your-health/health-condition-details-3');
});


router.post('/v25v5/health-form/about-your-health/health-condition-details-3', (req, res, next) => {
  res.redirect('/v25v5/health-form/about-your-health/health-condition-cya-3');
});


router.post('/v25v5/health-form/about-your-health/health-condition-cya-3', (req, res, next) => {
res.redirect('/v25v5/health-form/about-your-health/health-condition-cya-final');
});
